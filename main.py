...
def get_text_messages(message):
    if message.text.lower() == 'привет':
        ...
        response = requests.get('https://kudago.com/public-api/v1.4/events/?lang=&fields=id,title,description,dates,place&expand=&order_by=&text_format=text&ids=&location=spb&actual_since=1444385206&actual_until=1444385405&page_size=100').json()
        i = randint(0, 100)
        try:
